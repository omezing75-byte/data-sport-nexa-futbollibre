...
FLAG_CODE = {
    ...
    "Ecuador": "ec", "Perú": "pe", "Peru": "pe", "Chile": "cl",
    "Uruguay": "uy", "Paraguay": "py", "Bolivia": "bo",
    "México": "mx", "Mexico": "mx", "Costa Rica": "cr",
    "Panamá": "pa", "Panama": "pa", "Venezuela": "ve",
    "Estados Unidos": "us", "USA": "us", "Canadá": "ca", "Canada": "ca",
    "Inglaterra": "gb", "England": "gb", "Escocia": "gb",
    "España": "es", "Spain": "es", "Italia": "it",
    "Francia": "fr", "France": "fr", "Alemania": "de", "Germany": "de",
    "Portugal": "pt", "Países Bajos": "nl", "Netherlands": "nl",
    "Bélgica": "be", "Belgium": "be", "Turquía": "tr", "Turkey": "tr",
    "Arabia Saudita": "sa", "Saudi Arabia": "sa", "Qatar": "qa",
    "Japón": "jp", "Japan": "jp", "Corea del Sur": "kr", "South Korea": "kr",
    "Australia": "au",
}
